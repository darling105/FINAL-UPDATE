...
public class WeaponManager : MonoBehaviour
{
    ...
    public void SetWeaponDamage(CharacterManager characterWieldingWeapon, WeaponItem weapon)
    {
        ...
        meleeDamageCollider.running_Attack_01_Modifier = weapon.run_Attack_01_Modifier;
        meleeDamageCollider.rolling_Attack_01_Modifier = weapon.roll_Attack_01_Modifier;
